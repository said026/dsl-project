...
public class InternalFMLexer extends Lexer {
    ...
    public final void mT__18() throws RecognitionException {
        try {
            int _type = T__18;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:16:7: ( 'name=' )
            // InternalFM.g:16:9: 'name='
            {
            match("name="); 
    ...
    public final void mT__24() throws RecognitionException {
        try {
            int _type = T__24;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:22:7: ( '<constraints>' )
            // InternalFM.g:22:9: '<constraints>'
            {
            match("<constraints>"); 
    ...
    public final void mT__26() throws RecognitionException {
        try {
            int _type = T__26;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:24:7: ( '<rule>' )
            // InternalFM.g:24:9: '<rule>'
            {
            match("<rule>"); 
    ...
    public final void mT__28() throws RecognitionException {
        try {
            int _type = T__28;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:26:7: ( '<var' )
            // InternalFM.g:26:9: '<var'
            {
            match("<var"); 
    ...
    public final void mT__29() throws RecognitionException {
        try {
            int _type = T__29;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:27:7: ( 'mandatory' )
            // InternalFM.g:27:9: 'mandatory'
            {
            match("mandatory"); 
    ...
    public final void mRULE_RELATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:1916:15: ( ( 'and' | 'or' | 'alt' ) )
            // InternalFM.g:1916:17: ( 'and' | 'or' | 'alt' )
            {
            // InternalFM.g:1916:17: ( 'and' | 'or' | 'alt' )
            int alt1=3;
    ...
    public final void mRULE_OPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:1918:15: ( 'imp' )
            // InternalFM.g:1918:17: 'imp'
            {
            match("imp"); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:1920:13: ( '@@@@@@willnenverbecalled@@@@@' )
            // InternalFM.g:1920:15: '@@@@@@willnenverbecalled@@@@@'
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:1922:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalFM.g:1922:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalFM.g:1922:11: ( '^' )?
            int alt2=2;
            ...
            // InternalFM.g:1922:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:1924:10: ( ( '0' .. '9' )+ )
            // InternalFM.g:1924:12: ( '0' .. '9' )+
            {
            // InternalFM.g:1924:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:1926:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalFM.g:1926:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalFM.g:1926:24: ( options {greedy=false; } : . )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:1928:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalFM.g:1928:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalFM.g:1928:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:1930:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalFM.g:1930:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalFM.g:1930:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalFM.g:1932:16: ( . )
            // InternalFM.g:1932:18: .
            {
            matchAny(); 
    ...
    static final String DFA10_eotS =
        "\1\uffff\1\25\1\30\1\uffff\1\17\1\uffff\4\30\2\17\5\uffff\1\52\4\uffff\2\30\6\uffff\3\30\1\60\1\30\10\uffff\1\30\1\65\1\30\2\60\1\uffff\1\67\2\uffff\1\30\1\uffff\1\30\4\uffff\1\30\2\uffff\1\30\2\uffff\1\30\1\107\1\uffff\1\30\4\uffff\1\114\3\uffff";
    static final String DFA10_eofS =
        "\115\uffff";
    static final String DFA10_minS =
        "\1\0\1\57\1\141\1\uffff\1\52\1\uffff\1\141\1\154\1\162\1\155\1\100\1\101\4\uffff\1\145\1\143\4\uffff\1\155\1\164\6\uffff\1\156\1\144\1\164\1\60\1\160\3\uffff\1\141\1\145\3\uffff\1\145\1\60\1\144\2\60\1\uffff\1\60\1\164\1\141\1\75\1\uffff\1\141\1\uffff\1\165\1\164\1\uffff\1\164\1\162\1\165\1\157\1\145\2\162\1\104\1\145\1\171\3\uffff\1\104\1\60\3\uffff";
    static final String DFA10_maxS =
        "\1\uffff\1\166\1\157\1\uffff\1\76\1\uffff\1\141\1\156\1\162\1\155\1\100\1\172\4\uffff\1\145\1\162\4\uffff\1\155\1\164\6\uffff\1\156\1\144\1\164\1\172\1\160\3\uffff\1\141\1\145\3\uffff\1\145\1\172\1\144\2\172\1\uffff\1\172\1\164\1\141\1\75\1\uffff\1\141\1\uffff\1\165\1\164\1\uffff\1\164\1\162\1\165\1\157\1\145\2\162\1\115\1\145\1\171\3\uffff\1\115\1\172\3\uffff";
    static final String DFA10_acceptS =
        "\3\uffff\1\7\1\uffff\1\12\6\uffff\1\26\1\27\1\32\1\33\2\uffff\1\14\1\16\1\20\1\11\2\uffff\1\26\1\7\1\10\1\30\1\31\1\12\5\uffff\1\25\1\27\1\32\2\uffff\1\15\1\17\1\13\5\uffff\1\23\4\uffff\1\22\1\uffff\1\24\2\uffff\1\6\12\uffff\1\1\1\3\1\5\2\uffff\1\2\1\4\1\21";
    static final String DFA10_specialS =
        "\1\0\114\uffff}>";
    static final String[] DFA10_transitionS = {
            "\11\17\2\16\2\17\1\16\22\17\1\16\1\17\1\3\14\17\1\4\12\15\2\17\1\1\1\17\1\5\1\17\1\12\32\14\3\17\1\13\1\14\1\17\1\7\7\14\1\11\3\14\1\6\1\2\1\10\13\14\uff85\17",
